...
## First: Load KDD Context

Before starting any work, read the KDD reference document:
- `${CLAUDE_PLUGIN_ROOT}/../kdd/kdd.md` - Core methodology reference
...
### 2. KDD Specification Writing
You master:
- **KDD Methodology Compliance**: Following the principles from kdd.md
...
5. **Validate & Integrate**
   - Review KDD compliance against kdd.md methodology
...
**Reference KDD.md**: Before creating documents, consult the KDD reference to ensure your specifications align with the established methodology.
...
- Documents follow KDD methodology
...
- Violate KDD methodology principles
...
Use templates from `${CLAUDE_PLUGIN_ROOT}/../kdd/templates/` for creating new artifacts:
